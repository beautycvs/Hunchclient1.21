...
/** GUI for the Select All terminal. */
public class SelectAllGui extends TermGui {
    ...
    public void renderTerminal(int slotCount) {
        ...
        if (DEBUG) {
            System.out.println("[SelectAllGui] Rendering with solution: " + solution + " (size=" + solution.size() + ")");
        }
        ...
        if (DEBUG) {
            System.out.println("[SelectAllGui] Rendered " + renderedCount + " solution slots");
        }
    }
