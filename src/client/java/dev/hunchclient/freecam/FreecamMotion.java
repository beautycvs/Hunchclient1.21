...
/**
 * Motion handler for freecam movement.
 * Handles velocity calculations based on keyboard input.
 */
public class FreecamMotion {

    public static final double DIAGONAL_MULTIPLIER = Mth.sin((float) Math.toRadians(45));

    /**
     * Calculate and apply motion to the freecam entity.
     *
     * @param freeCamera The free camera entity
     * @param hSpeed     Horizontal speed
